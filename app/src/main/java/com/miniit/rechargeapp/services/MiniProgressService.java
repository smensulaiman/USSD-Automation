...
import com.miniit.rechargeapp.R;
import com.miniit.rechargeapp.utils.GifImageView;

public class MiniProgressService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        gifImageView.setGifImageResource(R.drawable.ic_launcher_background);
